...
async function HeroContent(targetpage) {
    ...
    const highlightedText = highlightByPattern(data.heading || "BETHEL FAMILY CHOIR, THE HOLY GATES OF HEAVEN");
    h1.innerHTML = highlightedText;


    const p = document.createElement("p");
    p.textContent = data.caption || "Welcome to our community! Join us in celebrating faith, music, and togetherness.";
